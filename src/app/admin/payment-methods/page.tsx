...
import { PaymentMethodType, FeeType } from "@prisma/client";
...
export default function PaymentMethodsPage() {
  ...
  const handleEdit = useCallback((paymentMethod: PaymentMethod) => {
    router.push(`/admin/payment-methods/${paymentMethod.id}`);
  }, [router]);
            ...
            <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
              <div className="container mx-auto px-4 lg:px-6">
                <div className="mb-6 flex items-center justify-between">
                  <div>
                    <h1 className="text-3xl font-bold">Kelola Payment Methods</h1>
                    <p className="mt-2 text-gray-400">
                      Atur dan pantau payment methods Anda di sini.
                    </p>
                  </div>
                  <Button onClick={() => router.push("/admin/payment-methods/new")}>
                ...
                {loading ? (
                  ...
                  <EmptyState
                    icon={CreditCard}
                    title={search ? "No payment methods found" : "No payment methods yet"}
                    description={
                      search
                        ? "Try adjusting your search criteria to find what you're looking for."
                        : "Add payment methods to allow customers to pay for their orders. You can configure bank transfers, e-wallets, and more."
                    }
                    action={
                      search
                        ? {
