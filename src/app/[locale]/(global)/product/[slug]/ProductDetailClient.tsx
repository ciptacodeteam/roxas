...
export default function ProductDetailClient({ slug }: { slug: string }) {
  ...
  const product = productDetail[slug as keyof typeof productDetail];
      ...
      <div className="relative z-10 bg-[url(/img/bgroxas.webp)] bg-cover bg-center bg-no-repeat">
        ...
        <div className="container mx-auto flex max-w-7xl items-start gap-6 px-4">
          ...
          <div className="pt-6 text-white">
            ...
            <p className="mb-4 text-gray-400">{product.brand}</p>
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="overflow-hidden rounded-2xl bg-gray-800">
              ...
              <div className="gap-6 p-4 md:grid-cols-2">
                ...
                <div className="grid grid-cols-3">
                  <Card className="group cursor-pointer overflow-hidden border-0 bg-[#313C4C] bg-[url(/img/background.png)] bg-cover bg-no-repeat px-0 py-0 pt-4 transition-all hover:outline-2 hover:outline-rose-500">
                    <CardHeader className="-mb-5">
                      <CardTitle className="text-sm text-white">
                        Weekly Diamond Pass
                      </CardTitle>
                      {/* <CardDescription>Card Description</CardDescription> <CardAction>Card Action</CardAction> */}
                    </CardHeader>
                    ...
                    <CardFooter className="from-card to-card/40 flex justify-end bg-linear-to-t p-3 px-3">
                      <div className="flex gap-3">
                        ...
                        <div className="bg-primary rounded-sm p-1 px-2">
                          <p className="text-xs text-white">Disc 52%</p>
                        </div>
                      </div>
                    </CardFooter>
                  </Card>
                  ...
                  <div className="group relative">
                    ...
                    <div className="group-hover:ring-primary flex cursor-pointer items-center justify-between rounded-md bg-[#313C4C] px-6 py-4 ring-2 ring-transparent transition-all duration-200">
                      ...
                      <div className="text-right">
                        <p className="font-medium text-white">Rp 98.789</p>
                      </div>
                    </div>
            ...
            <div className="overflow-hidden rounded-2xl bg-gray-800">
              ...
              <div className="flex items-center gap-4 bg-black/40">
                ...
                <h2 className="font-medium text-white">Detail Kontak</h2>
              </div>
              {/* Form */}
              <div className="p-4">
                <div className="flex flex-col gap-3">
